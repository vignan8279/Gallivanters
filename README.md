# Gallivanters
Helps data scientist to predict countries from their coin currencies.

![Alt Text](https://theauctioncollective.com/media/1048/justine_smith_money_map_of_the_world_china.jpg)
...
```bash
git clone https://github.com/your_github_username/Gallivanters.git
